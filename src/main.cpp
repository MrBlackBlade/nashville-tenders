...
Player s_obj (/*idle_ind*/ 0,/*run_ind*/ 0,/*jump_ind*/ 0,/*scale*/ 1,/*size_run*/ 40,/*sizeH_run*/ 50,/*size_idle*/ 28,/*sizeH_idle*/ 50,
 /*size_jump*/ 29,/*sizeH_jump*/ 50,/*anims_idle*/ 4,/*anims_run*/ 4,/*anims_jump*/ 9,/*velocityX*/ 0,/*MAXvelocityX*/ 40,/*ID*/ 0,/*isIdle*/ true);

Player b_obj (/*idle_ind*/ 0,/*run_ind*/0,/*jump_ind*/ 0,/*scale*/ 1,/*size_run*/ 64,/*sizeH_run*/ 64,/*size_idle*/ 64,/*sizeH_idle*/64,
 /*size_jump*/ 28,/*sizeH_jump*/ 64,/*anims_idle*/ 6,/*anims_run*/ 4,/*anims_jump*/ 4,/*velocityX*/ 0,/*MAXvelocityX*/ 25,/*ID*/ 1,/*isIdle*/ true);
