...
namespace Config
{
	...
	Pair_Object*			objects[OBJECTS] { &pGround, &pButton1, &pButton2, &pButton3, &pBox, &pChicken1, &pChicken2, &pChicken3, &pDoor1, &pDoor2, &pDoor3, &pElevator1, &pElevator2, &pElevator3, &pLever1, &pLever2, &pLever3, &pPlatform1, &pPlatform2, &pPlatform3, &pPlatform4, &pPlatform5, &pPlatform6, &pPlatform7, &pPlatform8, &pPlatform9, &pPlatform10 };
